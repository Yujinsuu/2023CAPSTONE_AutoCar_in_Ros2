...
class PerspectiveTransformation:
    ...
    def __init__(self):
        ...
        #htech
        self.src = np.float32([(647, 300), (302,589), (1357,589), (993,300)])    # top-right

        #kcity
        #self.src = np.float32([(788, 281), (478,589), (1245,589), (853,281)])
        self.dst = np.float32([(739,0), (739,590), (1139,590), (1139,0)])

        self.M = cv2.getPerspectiveTransform(self.src, self.dst)
        self.M_inv = cv2.getPerspectiveTransform(self.dst, self.src)

    def forward(self, img, img_size=(1640, 590), flags=cv2.INTER_NEAREST):
    ...
    def backward(self, img, img_size=(1640, 590), flags=cv2.INTER_LINEAR):
